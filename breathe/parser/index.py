...
class DoxygenType(GeneratedsSuper):
    ...
    def insert_compound_at(self, index, value): self.compound.insert(index, value)
    def replace_compound_at(self, index, value): self.compound[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='DoxygenType', fromsubclass_=False, pretty_print=True):
        ...
        for compound_ in self.compound:
            compound_.export(outfile, level, namespace_, name_='compound', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class CompoundType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CompoundType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CompoundType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CompoundType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CompoundType'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CompoundType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
